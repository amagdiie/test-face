...
import com.test.dogs.env.ImageUtils;
import com.test.dogs.env.Logger;
import com.test.dogs.tflite.Classifier;
            ...
            if (recognition != null) {
                ...
                if (recognition.getConfidence() != null){
                    ...
                    if (!backID && recognitionTextView.getText().toString()
                        ...
                        backID = true;
                        frontID = false;
                        Log.e("Ahmed", "BackIDCard: " + confi);

//                        ImageUtils.saveBitmap(tackScreenShot(mFrame), "BackIDCard.png");
    ...
    public Bitmap tackScreenShot(FrameLayout view){
