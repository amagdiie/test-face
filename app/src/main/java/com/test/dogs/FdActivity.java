...
public class FdActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dialogBuilder.setTitle("First Detect");
        dialogBuilder.setMessage("You Have to close your eye until you listen the beep Sound.");
    ...
    private void checkSecound() {
        AlertDialog.Builder dialogBuilder2 = new AlertDialog.Builder(this);
        dialogBuilder2.setTitle("Second Detect");
        dialogBuilder2.setMessage("You Have to open your eye until you listen the beep Sound.");
        dialogBuilder2.setPositiveButton(getString(R.string.dialog_ok_btn), (dialog, which) ->{
            new Handler().postDelayed(() -> {
                check++;
                AudioManager audioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
                audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, 10, 0);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        for (Rect rect : facesArray) {
            ...
            if (!HaarEyeOpen_R && !HaarEyeOpen_L && check == 1) {
                ...
                FrameEyesClosed++;
                FrameClosedDrowsy++;
            } else if (HaarEyeOpen_R && HaarEyeOpen_L && check == 2) {
